...
class Reparation extends Model
{
    ...
    // Relation avec le statut le plus récent
    public function latestReparationStatut()
    {
        return $this->hasOne(ReparationStatut::class, 'reparations_id')->latestOfMany('date_statut');
    }
}
